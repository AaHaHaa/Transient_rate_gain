...
%    A0t_backward - initial backward-propagating field in the time domain (Nt,1); sqrt(W)
%
%    Power_pump_forward - (Nt,1); the power of the co-propagating pump
%    Power_pump_backward - (Nt,1); the power of the counter-propagating pump
%
