...
%
% Output:
%    A1t_backward - the backwared-propagating field (in the time domain) after one step size (Nt,1)
%    Power_pump_backward - a (1,2) cell array of the power of the counter-propagating pump (Nt,1)
