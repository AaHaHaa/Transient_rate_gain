...
switch gain_rate_eqn.gain_medium
    case 'Yb'
        ...
        gain_rate_eqn.N.eqn.Arad = 1/gain_rate_eqn.N.eqn.tau;
        gain_rate_eqn.N.eqn.Gammai = [];
        
        gain_rate_eqn.N.eqn.tr = @F_twoLevel;
    case 'Er'
    ...
    case 'Tm'
        ...
        gain_rate_eqn.N.eqn.tr = @F_Tm;
        gain_rate_eqn.N.eqn.ss = FJ_Tm();
    case 'Ho'
        gain_rate_eqn.cross_section_filename = 'Ho.txt';
        %gain_rate_eqn.N.eqn.tau = 1.9e-3; % lifetime of Ho in 5I_7 state (Gouet et al., "Realization and simulation of high-power holmium doped fiber lasers for long-range transmission"); in "s"
        
        [gain_rate_eqn.N.eqn.Arad,gain_rate_eqn.N.eqn.Gammai,gain_rate_eqn.energy_levels] = calc_Judd_Ofelt(gain_rate_eqn);
        
        gain_rate_eqn.N.eqn.tr = @F_Ho;
