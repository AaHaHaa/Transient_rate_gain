...
figure;
h = plot(t1/1e6,(1-prop_output(1).population(:,:,end)/gain_rate_eqn.N_total)*100,'linewidth',2);
set(h,'Color','b');
set(gca,'fontsize',20);
xlabel('Time (ms)'); ylabel('N_2 (%)');
print(gcf,'N2_1_woASE.jpg','-djpeg');

figure;
yyaxis left;
plot(t,(1-prop_output(2).population(:,:,end)/gain_rate_eqn.N_total)*100,'linewidth',2);
ylabel('N_2 (%)');
yyaxis right;
