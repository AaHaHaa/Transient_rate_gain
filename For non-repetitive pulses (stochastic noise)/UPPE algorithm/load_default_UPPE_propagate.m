...
%
%           SR - SR tensor, in m^-2
%                For single-mode here, it's 1/Aeff.
...
%       fields.backward - initial backard-propagating field in the time domain; a (Nt,1) array; sqrt(W)
%
% -------------------------------------------------------------------------
%
...
elseif default_sim.lambda0 < 1e-6 % assume at 920 nm, where Nd is used
    ...
    default_fiber.MFD = 4; % um; from IXblue's IXF-2CF-PAS-PM-4-80-0.16-P
