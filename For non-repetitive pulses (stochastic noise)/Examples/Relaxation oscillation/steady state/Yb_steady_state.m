...
fiber.L0 = 1.6; % m; fiber length
fiber.MFD = 10; % um; mode-field diameter; this is the default settings loaded below
...
gain_rate_eqn.absorption_to_get_N_total = 6.5; % dB/m
...
gain_rate_eqn.t_rep = 1/120e6; % Assume 10 MHz here; s; the time required to finish a roundtrip (the inverse repetition rate of the pulse)
