...
%% cavity parameters
max_rt = 5e4; % maximum roundtrips (in case it doesn't converge)
each_max_rt = 1000;
OC = 0.96; % output coupling
loss = 0.15; % the total loss of the cavity
...
while rt_num <= max_rt
    ...
    while rt_num_thousand ~= 0
        ...
        if rt_num < 5
            saturation_power_Q = 0.01;
        else
            saturation_power_Q = 1e-10;
        end
