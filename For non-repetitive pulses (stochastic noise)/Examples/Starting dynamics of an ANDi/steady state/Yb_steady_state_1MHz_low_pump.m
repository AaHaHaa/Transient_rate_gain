...
gain_rate_eqn.t_rep = 1/1e6; % Assume 10 MHz here; s; the time required to finish a roundtrip (the inverse repetition rate of the pulse)
...
save('ss_for_initial_N_1MHz_low_pump.mat');