...
%%
load('../steady state/ss_for_initial_N_1MHz_low_pump.mat');
...
save('oscillator_general_info_low_pump.mat');
...
while rt_num <= max_rt
    ...
    close all;
    save(sprintf('oscillator_low_pump_%u.mat',rt_num-1),'output_field','output_energy','population1','population2','population3','population4','pump1','pump2','pump3','pump4');
end