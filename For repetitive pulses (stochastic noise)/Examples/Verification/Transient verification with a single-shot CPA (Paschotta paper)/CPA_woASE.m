% This duplicate the paper:
%
% Rudiger Paschotta, "Modeling of ultrashort pulse amplification with gain
% saturation," Opt. Express 25, 19112-19116 (2017)
%
% This simulation is slower than ordinary cases because its population
% varies significantly in the window, leading to difficult MPA convergence
% to find the population N(t) that satisfies the periodic boundary
% condition.
...
gain_rate_eqn.copump_power = 0.73; % W
