% This code aims to duplicate Fig. 6 in
%
...
gain_rate_eqn.copump_power = 4.8; % W
...
tfwhm = 0.4; % ps
total_energy = 1.5e3; % nJ

pulse_lambda0 = 1030e-9;
f_now = c/sim.lambda0*1e-12;
f_pulse = c/pulse_lambda0*1e-12;
freq_shift = f_pulse - f_now;
input_field1 = build_MMgaussian(tfwhm, time_window, total_energy, 1, Nt, {'ifft',freq_shift},1,-300);
input_field2 = build_MMgaussian(tfwhm, time_window, total_energy, 1, Nt, {'ifft',freq_shift},1,300);
...
save('two_nsPulses_offsetTime.mat');