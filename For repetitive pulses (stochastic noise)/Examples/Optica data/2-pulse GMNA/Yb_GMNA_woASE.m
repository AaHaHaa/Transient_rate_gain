...
% (GMNA) in a two-pulse burst-mode operation.
...
%%
function run_GMNA(DT)
% DT: pulse separation; ps
...
% sim.include_Raman = true; Consider Raman model
...
energy_coeff = linspace(1,1,num_pulses); % equal energy among pulses
