function [optimal_value,dechirped_FWHM,dechirped_field,varargout] = pulse_compressor_bursts( compressor_type,theta_in,wavelength0,time,field,varargin )
%PULSE_COMPRESSOR_BURSTS Find the optimum grating/prism separation and the corresponding dechirped field after different types of compressors
%
...
% Default parameters
optargs = {0, false false -1};
% Load paramters
optargs(1:length(varargin)) = varargin;
[initial_guess,verbose,global_opt,m] = optargs{:};
...
switch compressor_type
    case {'Treacy-beta2','Treacy-r','Treacy-t'}
        [optimal_separation,dechirped_FWHM,dechirped_field,grating_size,roof_mirror_size,recover_info] = Treacy(compressor_type,theta_in,wavelength0,time,field,grating_spacing,initial_guess,verbose,m,global_opt);
        optimal_value = optimal_separation;
        varargout = {grating_size,roof_mirror_size,recover_info};
    case 'prism'
        [optimal_separation,dechirped_FWHM,dechirped_field,prism_height,roof_mirror_size,theta_in,recover_info] = prism(wavelength0,time,field,alpha,prism_material,initial_guess,verbose,global_opt);
        optimal_value = optimal_separation;
        varargout = {prism_height,roof_mirror_size,theta_in,recover_info};
    case {'grism1','grism2'}
        [optimal_separation,dechirped_FWHM,dechirped_field,grism_height,roof_mirror_size,recover_info] = grism(compressor_type,theta_in,wavelength0,time,field,grating_spacing,alpha,prism_material,initial_guess,verbose,m,global_opt);
        optimal_value = optimal_separation;
        varargout = {grism_height,roof_mirror_size,recover_info};
    case 'Offner1'
        [optimal_offcenter,dechirped_FWHM,dechirped_field,grating_size,roof_mirror_size,concave_size,convex_size,recover_info] = Offner(compressor_type,theta_in,wavelength0,time,field,grating_spacing,R,0,         initial_guess,verbose,m,global_opt);
        optimal_value = optimal_offcenter;
        varargout = {grating_size,roof_mirror_size,concave_size,convex_size,recover_info};
    case 'Offner2'
        [optimal_separation,dechirped_FWHM,dechirped_field,grating_size,roof_mirror_size,concave_size,convex_size,recover_info] = Offner(compressor_type,theta_in,wavelength0,time,field,grating_spacing,R,offcenter,initial_guess,verbose,m,global_opt);
        optimal_value = optimal_separation;
        varargout = {grating_size,roof_mirror_size,concave_size,convex_size,recover_info};
    case 'Offner3'
        [optimal_separation,dechirped_FWHM,dechirped_field,grating_size,roof_mirror_size,concave_size,convex_size,recover_info] = Offner(compressor_type,theta_in,wavelength0,time,field,grating_spacing,R,0,        initial_guess,verbose,m,global_opt);
        optimal_value = optimal_separation;
        varargout = {grating_size,roof_mirror_size,concave_size,convex_size,recover_info};
    case 'Martinez'
        [optimal_separation,dechirped_FWHM,dechirped_field,grating_size,roof_mirror_size,lens1_size,lens2_size,recover_info] = Martinez(theta_in,wavelength0,time,field,grating_spacing,focal_length,initial_guess,verbose,m,global_opt);
        optimal_value = optimal_separation;
...
%%
function [optimal_separation,dechirped_FWHM,dechirped_field,grating_size,roof_mirror_size,recover_info] = Treacy(compressor_type,theta_in,wavelength0,time,field,grating_spacing,initial_guess,verbose,m,global_opt)
%TREACY
...
if separation > 0
    ...
    % Prevent pulse moving
    c = 299792.458; % nm/ps
    f = c./wavelength; % THz
    f0 = c/wavelength0;
    f_range = max(f)-min(f);
    f_idx_near_pulse = f>f0-f_range/5 & f<f0+f_range/5;% pick only the data near the pulse center frequency to find its beta0 and beta1
    [phase_Taylor_coeff,~,mu] = polyfit(f(f_idx_near_pulse),unwrap(total_phase(f_idx_near_pulse)),7);
    offset_phase = phase_Taylor_coeff(end-1);
    offset_phase = offset_phase/mu(2);
    total_phase = total_phase - offset_phase*(f-mu(1));
...
%%
function [optimal_separation,dechirped_FWHM,dechirped_field,prism_height,roof_mirror_size,theta_in,recover_info] = prism(wavelength0,time,field,alpha,prism_material,initial_guess,verbose,global_opt)
%PRISM
...
%%
function [optimal_separation,dechirped_FWHM,dechirped_field,grism_height,roof_mirror_size,recover_info] = grism(compressor_type,theta_in,wavelength0,time,field,grating_spacing,alpha,prism_material,initial_guess,verbose,m,global_opt)
%GRISM
...
%%
function [optimal_value,dechirped_FWHM,dechirped_field,grating_size,roof_mirror_size,concave_size,convex_size,recover_info] = Offner(compressor_type,theta_in,wavelength0,time,field,grating_spacing,R,offcenter,initial_guess,verbose,m,global_opt)
%OFFNER
...
%%
function [optimal_separation,dechirped_FWHM,dechirped_field,grating_size,roof_mirror_size,lens1_size,lens2_size,recover_info] = Martinez(theta_in,wavelength0,time,field,grating_spacing,focal_length,initial_guess,verbose,m,global_opt)
%Martinez
