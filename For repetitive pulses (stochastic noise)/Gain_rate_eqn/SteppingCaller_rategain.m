...
if sim.gpu_yes
    [At_forward,At_backward,...
     Power_pump_forward,Power_pump_backward] = mygather2(1,num_zPoints,...
                                                         At_forward,At_backward,...
...
for ii = 2:num_zPoints
    ...
    switch direction
        ...
        case 'forward'
            ...
            last_At_backward = At_backward(:,:,Zi-1,:); % = initial_condition.fields.backward
            last_Power_pump_backward = Power_pump_backward(:,:,Zi-1,:);
            
            % Since backward pump power and the backward field are functions of time,
